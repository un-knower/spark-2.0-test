...
import com.common.{Log, ZooKeeperOffsetsStore}
import com.kafka.{Message, TransEventMessage}
import com.typesafe.config.ConfigFactory
import com.util.{DateUtil, RedisUtil}
...
/**
  ...
  *
  * 停止：
  * ps -ef | grep spark |  grep TransEvent | awk '{print $2}'   | xargs kill  -SIGTERM
  *
  */

object TransEvent extends Log {
    ...
    def main(args: Array[String]) {
        ...
        val sparkConf = new SparkConf().setAppName("TransEvent")
