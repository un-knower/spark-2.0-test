...
/**
  ...
  *
  * 停止：
  * ps -ef | grep spark |  grep StoreTransEvent | awk '{print $2}'   | xargs kill  -SIGTERM
  *
  */

object StoreTransEvent extends Log{
  ...
  def main(args: Array[String]) {
    ...
    val sparkConf = new SparkConf().setAppName("StoreTransEvent")
